...
const HomeBoard = (props) => {
  ...
  const [columns, setColumns] = useState({
    ...
    [inProgressId]: {
      ...
      items: [
        // {
        //   id: uuidv4(),
        //   name: "First tasksssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss",
        //   category: "UI",
        //   endDate: "01-01-2020",
        // },
        // {
        ...
        assignmentService.getBoard(id).then((results) => {
          ...
          if (results.data.todo.length !== 0) {
            results.data.todo.forEach((todoTask) => {
              todoTask.endedDate = moment(todoTask.endedDate).format(
                "DD/MM/YYYY"
              );
            });
          }
          if (results.data.inProgress.length !== 0) {
            results.data.inProgress.forEach((inProgressTask) => {
              inProgressTask.endedDate = moment(
                inProgressTask.endedDate
              ).format("DD/MM/YYYY");
            });
          }
  ...
  return isLoading !== true ? (
    <div className="board-table">
      ...
      {/* Change to table view button */}
      <div className="table-view-button-container">
        <button
    ...
    <div style={{ width: "100vw", height: "70vh" }} className="loading">
