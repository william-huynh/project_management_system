...
const BoardProblem = (props) => {
  ...
  const fetchData = () => {
    problemService.getBoard(id).then((results) => {
      setIsLoading(false);
  ...
  const onDragEnd = (result, columns, setColumns) => {
    ...
    if (source.droppableId !== destination.droppableId) {
      ...
      problemService.updateStatus(result.draggableId, destColumn.name);
