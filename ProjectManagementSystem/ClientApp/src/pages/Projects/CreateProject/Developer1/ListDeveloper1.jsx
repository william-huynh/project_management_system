...
const ListDeveloper1 = (props) => {
  ...
  return (
    <div>
      <div>
        <p className="header-project-list">Select Developer 1</p>
      </div>
      <Divider />
      <Table
        rowSelection={{
          type: "radio",
          defaultSelectedRowKeys: [props.DefaultDeveloper],
          ...rowSelection,
        }}
        columns={columns}
        dataSource={data}
